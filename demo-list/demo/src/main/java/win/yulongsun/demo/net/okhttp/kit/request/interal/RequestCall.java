...
import win.yulongsun.demo.net.okhttp.kit.OkHttpKit;
...
public class RequestCall {
    ...
    public void execute(ICallback callback) {
        ...
        if (readTimeout > 0 || writeTimeout > 0 || connectTimeout > 0) {
            readTimeout = readTimeout > 0 ? readTimeout : OkHttpKit.DEFAULT_MILLISECONDS;
            writeTimeout = writeTimeout > 0 ? writeTimeout : OkHttpKit.DEFAULT_MILLISECONDS;
            connectTimeout = connectTimeout > 0 ? connectTimeout : OkHttpKit.DEFAULT_MILLISECONDS;
            //
            client.newBuilder()
