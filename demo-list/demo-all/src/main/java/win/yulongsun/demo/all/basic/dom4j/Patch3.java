package win.yulongsun.demo.all.basic.reflect.dom4j;
...
public class Patch3 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //_* 为新文件
        // *为旧文件
        Document _document = reader.read("D:\\me\\learn-list\\demo-list\\demo-all\\src\\main\\java\\win\\yulongsun\\other\\dom4j/msdsf_convert_new.xml");
        Document document = reader.read("D:\\me\\learn-list\\demo-list\\demo-all\\src\\main\\java\\win\\yulongsun\\other\\dom4j/msdsf_convert.xml");
